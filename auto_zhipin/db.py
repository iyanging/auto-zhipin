...
class Cookie(Base):
    ...
    async def overwrite_all(cls, session: AsyncSession, cookies: "Sequence[Cookie]") -> None:
        ...
        cls.logger.info("Saved cookies pruned")
...
#
#     boss_zhipin_url: Mapped[str] = mapped_column(primary_key=True)
